                ...
                {showLoginModal && (
                    ...
                    >
                        <motion.div
                            ...
                            className="relative w-full max-w-md p-5 sm:p-8 rounded-3xl bg-gradient-to-b from-[#181614] via-[#12110f] to-black border border-white/20 shadow-[0_30px_100px_rgba(0,0,0,0.95),0_0_50px_rgba(212,165,116,0.15)]"
                        >
