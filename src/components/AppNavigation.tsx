                        ...
                        <AnimatePresence>
                            {openDropdown === 'tools' && (
                                <motion.div
                                    ...
                                    animate="visible"
                                    exit="exit"
                                    className="absolute top-[120%] left-1/2 -translate-x-1/2 mt-1 w-72 max-w-[90vw] p-3 glass-panel rounded-2xl shadow-neo-lg border border-white/10"
                                >
                        ...
                        <AnimatePresence>
                            {openDropdown === 'devices' && (
                                <motion.div
                                    ...
                                    animate="visible"
                                    exit="exit"
                                    className="absolute top-[120%] left-1/2 -translate-x-1/2 mt-1 w-64 max-w-[90vw] p-2 glass-panel rounded-2xl shadow-neo-lg border border-white/10"
                                >
