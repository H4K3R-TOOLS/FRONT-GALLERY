                            ...
                            {openDropdown === 'tools' && (
                                <>
                                    ...
                                    <motion.div
                                        ...
                                        animate="visible"
                                        exit="exit"
                                        className="fixed left-4 right-4 top-[75px] w-auto sm:absolute sm:top-[120%] sm:left-1/2 sm:right-auto sm:-translate-x-1/2 sm:mt-2 sm:w-[380px] p-6 glass-panel rounded-3xl shadow-neo-2xl border border-white/10 bg-black/40 backdrop-blur-3xl z-[200] transform-gpu origin-top"
                                    >
                            ...
                            {openDropdown === 'devices' && (
                                <>
                                    ...
                                    <motion.div
                                        ...
                                        animate="visible"
                                        exit="exit"
                                        className="fixed left-4 right-4 top-[75px] w-auto sm:absolute sm:top-[120%] sm:left-1/2 sm:right-auto sm:-translate-x-1/2 sm:mt-2 sm:w-[360px] p-6 glass-panel rounded-3xl shadow-neo-2xl border border-white/10 bg-black/40 backdrop-blur-3xl z-[200] transform-gpu origin-top"
                                    >
